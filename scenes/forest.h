...
public:
    static void run() {
        ...
        auto scene1 = std::make_shared<Scene>(960, 272*2, 5);
        scene1->at(4)->background("rsrc/sprites/backgrounds/bg.png");
        scene1->at(3)->background("rsrc/sprites/backgrounds/far_trees.png");
        scene1->at(2)->background("rsrc/sprites/backgrounds/mid_trees.png");
        scene1->at(0)->background("rsrc/sprites/backgrounds/close_trees.png");
